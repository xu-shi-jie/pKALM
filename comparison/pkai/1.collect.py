...
# shutil.rmtree('comparison/pkai/pdbs', ignore_errors=True)
Path('comparison/pkai/pdbs').mkdir(parents=True, exist_ok=True)

raw_pdbs = Path(r'data/fixed_pdbs')
for pdbid in unique_pdbids:
    # copy pdb file
    pdb_file = raw_pdbs / f'{pdbid}.pdb'
    shutil.copy(pdb_file, r'comparison/pkai/pdbs')
